...
import pandas as pd
from .model import RegressorLiftedHeston
...
for e in range(epochs_iter):
    ...
    for features, labels in train_loader:
        ...
        if test_loss <= test_loss_min:
            ...
            torch.save(model.state_dict(), 'ckpt_model/modelLiftedHeston.pt')
    ...
    learning_data.to_csv('learning_csv/'+log_df,index=False)
